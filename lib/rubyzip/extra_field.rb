...
require 'rubyzip/extra_field/generic'
require 'rubyzip/extra_field/universal_time'
require 'rubyzip/extra_field/old_unix'
require 'rubyzip/extra_field/unix'
require 'rubyzip/extra_field/zip64'
require 'rubyzip/extra_field/zip64_placeholder'
