module RubyZip
  ...
  class InputStream
    include ::RubyZip::IOExtras::AbstractInputStream
    ...
    def initialize(context, offset = 0)
      ...
      @decompressor  = ::RubyZip::NullDecompressor
      @current_entry = nil
    end
    ...
    def open_entry
      @current_entry = ::RubyZip::Entry.read_local_entry(@archive_io)
    ...
    def get_decompressor
      ...
      when @current_entry.nil?
        ::RubyZip::NullDecompressor
      when @current_entry.compression_method == ::RubyZip::Entry::STORED
        ::RubyZip::PassThruDecompressor.new(@archive_io, @current_entry.size)
      when @current_entry.compression_method == ::RubyZip::Entry::DEFLATED
        ::RubyZip::Inflater.new(@archive_io)
      else
