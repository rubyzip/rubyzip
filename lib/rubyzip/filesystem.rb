...
module RubyZip
  ...
  # classes.
  #
  # Requiring 'rubyzip/filesystem' includes this module in RubyZip::File
  # making the methods in this module available on RubyZip::File objects.
  #
  ...
  module FileSystem
    ...
    # object, except it works on the RubyZip::File on which this method is
    # invoked
    def dir
      @zipFsDir
    end
    ...
    # RubyZip::File::file. An instance of ZipFsFile behaves like ruby's
    # builtin File (class) object, except it works on RubyZip::File entries.
    #
...
#      protected :dir
    ...
    # All access to RubyZip::File from ZipFsFile and ZipFsDir goes through a
